...
class InventoryPlanningService(
    ...
    fun planUsingCurrentFuturePrediction() {
        val timeTransformations = measureTimeMillis {
            ...
            val timePersist = measureTimeMillis {
            ...
            println("Time taken to persist: $timePersist")
        }

        println("Total time: $timeTransformations")
    }
    ...
    fun clearOrdenes() = ordenCompraMesRepository.deleteAll()
